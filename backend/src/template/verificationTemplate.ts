export const VerificationTemplate = (verificationCode: string) => `<!DOCTYPE html
...
<body class="clean-body u_body" style="
  ...
  <table role="presentation" id="u_body" style="
        border-collapse: collapse;
        table-layout: fixed;
        border-spacing: 0;
                            ...
                            <td style="
                              ...
                              <div style="
                                ...
                                <p style="line-height: 140%; margin: 0px">
                                  Please verify you're really you by entering
                                  this
                                </p>
                                <p style="line-height: 140%; margin: 0px">
                                  6-digit code when you sign in. Just a heads
                                  up, this code will expire
                                </p>
                                <p style="line-height: 140%; margin: 0px">
                            ...
                            <td style="
                              ...
                              <h1 style="
                                ...
                                <span style="
                                      ...
                                      float: none;
                                      display: inline;
                                    ">If you didn&rsquo;t request this, you can
                          ...
                          <tr>
                            <td style="
                              ...
                              <h1 style="
                                    ...
                                    font-weight: 400;
                                  ">
                                <span><span><span><span>If you have any questions, contact
                                        our Website &nbsp;Guides at
                                        yourdomain.com .<br />Or, visit our
                                        Help Center.<br /></span></span></span></span>
                              </h1>
                              <!--[if mso]></td></tr></table><![endif]-->
                            </td>
                          </tr>
                          ...
                          <tr>
                            <td style="
                              ...
                              <div style="
                                    ...
                                    word-wrap: break-word;
                                  ">
                                <blockquote data-start="228" data-end="368">
                                  <p style="line-height: 140%; margin: 0px" data-start="230" data-end="368">
                                    <strong data-start="230" data-end="281">Discover top-notch gadgets at
                                      unbeatable value.</strong><br data-start="281" data-end="284" />From smartphones
                                    to cameras, we bring
                                    you the latest in electronics you can
                                    trust.
                                  </p>
                                </blockquote>
                              </div>
                        ...
                        <tbody>
                          <tr>
                            <td style="
                                  ...
                                  font-family: arial, helvetica, sans-serif;
                                " align="left">
                              <table role="presentation" aria-label="divider" height="0px" align="center" border="0"
                            ...
                            <td style="
                              ...
                              <div style="
                                ...
                                <p style="
                                    ...
                                    ">
                                  Explore more at
                                  <a rel="noopener" class="cursor-pointer" target="_new" data-start="877" data-end="921"
                                    style="
                                        color: rgb(0, 0, 238);
                                        text-decoration: underline;
                                        line-height: inherit;
                                      "><strong data-start="878" data-end="896">yourdomain.com</strong></a>
                                  &mdash; Your one-stop shop for premium
                                  electronics.
                                </p>
                              </div>
                            </td>
                            ...
                            <td style="
                              ...
                              <div align="center" style="direction: ltr" aria-label="social">
                                <div style="display: table; max-width: 187px">
                                  ...
                                  <table role="presentation" aria-label="X icon" border="0" cellspacing="0"
                                    ...
                                    <tbody>
                                      <tr style="vertical-align: top">
                                        <td valign="middle" style="
                                              ...
                                              vertical-align: top;
                                            ">
                                          <a href="https://twitter.com/unlayerapp" title="X" target="_blank" style="
                                                color: rgb(0, 0, 238);
                                                text-decoration: underline;
                                                line-height: inherit;
                                              "><img src="images/image-2.png" alt="X icon" title="X" width="32" style="
                                                  outline: none;
                                                  text-decoration: none;
                                                  -ms-interpolation-mode: bicubic;
                                                  clear: both;
                                  ...
                                  <!--[if (mso)|(IE)]><td width="32" style="width:32px; padding-right: 15px;" valign="top"><![endif]-->
                                  <table role="presentation" aria-label="LinkedIn icon" border="0" cellspacing="0"
                                    cellpadding="0" width="32" height="32" style="
                                        width: 32px !important;
                                        height: 32px !important;
                                        display: inline-block;
                                    ...
                                    <tbody>
                                      <tr style="vertical-align: top">
                                        <td valign="middle" style="
                                              ...
                                              vertical-align: top;
                                            ">
                                          <a href="https://linkedin.com/" title="LinkedIn" target="_blank" style="
                                                color: rgb(0, 0, 238);
                                                text-decoration: underline;
                                                line-height: inherit;
                                              "><img src="images/image-3.png" alt="LinkedIn icon" title="LinkedIn"
                                              width="32" style="
                                                  outline: none;
                                                  text-decoration: none;
                                                  -ms-interpolation-mode: bicubic;
                                  ...
                                  <!--[if (mso)|(IE)]><td width="32" style="width:32px; padding-right: 15px;" valign="top"><![endif]-->
                                  <table role="presentation" aria-label="Discord icon" border="0" cellspacing="0"
                                    cellpadding="0" width="32" height="32" style="
                                        width: 32px !important;
                                        height: 32px !important;
                                        display: inline-block;
                                    ...
                                    <tbody>
                                      <tr style="vertical-align: top">
                                        <td valign="middle" style="
                                              ...
                                              vertical-align: top;
                                            ">
                                          <a href="https://discordapp.com/" title="Discord" target="_blank" style="
                                                color: rgb(0, 0, 238);
                                                text-decoration: underline;
                                                line-height: inherit;
                                              "><img src="images/image-4.png" alt="Discord icon" title="Discord"
                                              width="32" style="
                                                  outline: none;
                                                  text-decoration: none;
                                                  -ms-interpolation-mode: bicubic;
                                  ...
                                  <table role="presentation" aria-label="Reddit icon" border="0" cellspacing="0"
                                    cellpadding="0" width="32" height="32" style="
                                        width: 32px !important;
                                        height: 32px !important;
                                        display: inline-block;
                                    ...
                                    <tbody>
                                      <tr style="vertical-align: top">
                                        <td valign="middle" style="
                                              ...
                                              vertical-align: top;
                                            ">
                                          <a href="https://reddit.com/" title="Reddit" target="_blank" style="
                                                color: rgb(0, 0, 238);
                                                text-decoration: underline;
                                                line-height: inherit;
                                              "><img src="images/image-5.png" alt="Reddit icon" title="Reddit"
                                              width="32" style="
                                                  outline: none;
                                                  text-decoration: none;
                                                  -ms-interpolation-mode: bicubic;
